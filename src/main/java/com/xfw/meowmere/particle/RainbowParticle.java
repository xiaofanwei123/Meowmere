package com.xfw.meowmere.particle;
...
public class RainbowParticle extends Particle {
    ...
    private static final RenderType RAINBOW_RENDER_TYPE = getTeslaBulb(Meowmere.Resource("textures/particle/rainbow.png"));
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTick) {
        ...
        while (vertIndex < bakedRainbowVecs.length - 1) {
            ...
            vertexconsumer.addVertex(posestack$pose, (float) draw1.x, (float) draw1.y, (float) draw1.z + width).setColor(1F, 1F, 1F, alpha0).setUv(u1, 1F).setOverlay(NO_OVERLAY).setLight(j).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
            vertexconsumer.addVertex(posestack$pose, (float) draw2.x, (float) draw2.y, (float) draw1.z + width).setColor(1F, 1F, 1F, alpha1).setUv(u2, 1F).setOverlay(NO_OVERLAY).setLight(j).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
            vertexconsumer.addVertex(posestack$pose, (float) draw2.x, (float) draw2.y, (float) draw2.z - width).setColor(1F, 1F, 1F, alpha1).setUv(u2, 0).setOverlay(NO_OVERLAY).setLight(j).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
            vertexconsumer.addVertex(posestack$pose, (float) draw1.x, (float) draw1.y, (float) draw2.z - width).setColor(1F, 1F, 1F, alpha0).setUv(u1, 0).setOverlay(NO_OVERLAY).setLight(j).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
            vertIndex++;
            posestack.popPose();
        }
